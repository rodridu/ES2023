...
global root "/Users/hongz/Downloads/choices13k-main"
...
*--------------Loading Data--------------* 
import delimited "$root/sample.csv", clear
...
export delimited "$root/examp.csv", replace
*import coefficients
frame create coef
frame change coef
clear
import delimited "$root/new_coef.csv"
destring, replace
...
save "$root/index_calculated_stata.dta", replace
export delimited "$root/index_calculated_stata.csv", replace
